    ...
    <LayoutInforme pagina={'Actual'}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className=' grid grid-cols-1 md:grid-cols-2'>
                ...
                <div>
                  ...
                  <h2 class="text-2xl font-bold text-gray-600">{formatoNumero(totalVolumenA)} m³ / {formatoNumero(totalCantidadA)} Und.</h2>
                </div>
              </div>     
            </div>
          </div>
        ...
        <div className='grid sm:hidden grid-cols-2 gap-1'> 
          <div className="border border-solid rounded-lg text-center shadow grid gap-1 grid-cols-2 p-2 hover:border-red-700">
            <Link href="/informe-aserradero-fecha">
              <p className="text-center uppercase font-bold text-xl">Detalle</p>
        ...
        <div className='m-auto w-full  border-gray-100 px-5 py-6 pb-1'>
          ...
          <Link href="/listado-turnos" className="py-0 w-full text-gray-400 hover:text-gray-800">
            <span className="">
              <span className="text-xs pb-1 py-0">Sabana Completa</span>
            </span>
          </Link>
        </div>

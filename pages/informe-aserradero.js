...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          ...
          <div className="shadow rounded-lg p-2">
          <div className=''>
          <p className="font-semibold text-gray-600">Filtrar por productos</p>
          ...
          <div className='shadow rounded-lg p-2'>
          <p className="font-semibold text-gray-600">Filtrar por Fecha</p>
        ...
        <div className='mx-auto w-full border-b border-gray-100 px-5 py-6 pb-6'>
                <p className='font-semibold text-gray-800  border-b border-gray-100'>Produccion Actual</p>
        ...
        {dataActual && dataActual.length ? dataActual.map(produccion =>

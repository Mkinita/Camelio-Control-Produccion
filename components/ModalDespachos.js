        ...
        <div className="md:w-" key={oc.id}>
            ...
            <table class="w-full table-auto text-center shadow-lg">
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                        ...
                        <tr> 
                            <td class="p-2">
                                <div class="font-medium text-gray-800">{oc.espesor}</div>
                            </td>
                            <td class="p-2">
                                <div class="font-medium text-gray-800">{oc.ancho}</div>
                        </td>
                            <td class="p-2">
                                <div class="font-medium text-gray-800">{oc.largo}</div>
                            </td>
                            <td class="p-2">
                                <div class="font-medium text-gray-800">{oc.piezas}</div>
                            </td>
                        </tr>  
            ...
            onClick={() => handleAgregarPedidoDespacho({ ...productos, cantidad })}
            >
            {"Agregar"}
            </button>
        </div>

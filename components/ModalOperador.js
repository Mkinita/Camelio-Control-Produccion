...
const ModalProductos = () => {
  const { operadores, handleChangeModal, handleAgregarOperador, pedido} = useCombustible();
  ...
  return (
    ...
    <div className="md:flex gap-10">
        <div className="md:w-">
            ...
            <h1 className="text-xl font-bold mt-1 text-center p-2">{operadores.operador}</h1>
            <table class="w-full table-auto text-center shadow-lg">
                ...
                <tbody class="divide-y divide-gray-100 text-xl">
                    <tr> 
                        <td class="p-2">
                            <div class="font-medium text-gray-800">{operadores.operador}</div>
                        </td>
                    </tr>  
                </tbody>
            </table> 
            ...
            onClick={() => handleAgregarOperador({ ...operadores, cantidad })}
            >
            {"Agregar"}
            </button>
        </div>
